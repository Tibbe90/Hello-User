...
public class MemberPageController {
    ...
    static {
        ...
        memberList.add(new Member("Mikael Sanfridsson", 36, "Master Mechanic", "1988 Honda CRX", true));
        memberList.add(new Member("Carolina Tibbelin", 33, "Bookkeeping", "2005 Honda Accord", true));
