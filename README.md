...
- I did quite quickly set up the member class and the 3 pages, Displaying the different members with thymeleaf. Communicating the user Id's between frontend and backend
